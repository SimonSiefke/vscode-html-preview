...
<body data-id="28">
  ...
  <script data-id="37" src="js/vendor/modernizr-{{MODERNIZR_VERSION}}.min.js"></script>
  <script data-id="39" src="https://code.jquery.com/jquery-{{JQUERY_VERSION}}.min.js" integrity="{{JQUERY_SRI_HASH}}" crossorigin="anonymous"></script>
  <script data-id="41">window.jQuery || document.write('<script src="js/vendor/jquery-{{JQUERY_VERSION}}.min.js"></script>')</script>
  <script data-id="45" src="js/plugins.js"></script>
  <script data-id="47" src="js/main.js"></script>
  ...
  <script data-id="54" src="https://www.google-analytics.com/analytics.js" async></script>
</body>
