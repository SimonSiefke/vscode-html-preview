...
test('insert-002-insert-text-between-text-and-comment', async () => {
	const uri = await createTestFile('insert-002-insert-text-between-text-and-comment.html')
  await setText(`a<!--c-->`)
  ...
  await page.goto('http://localhost:3000/insert-002-insert-text-between-text-and-comment.html', {waitUntil: 'networkidle2', timeout: 15000})
