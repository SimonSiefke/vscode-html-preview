...
test('useless-whitespace-change-2', async () => {
  ...
  await page.goto('http://localhost:3000/useless-whitespace-change-2.html', {waitUntil: 'networkidle2', timeout: 10000})
  //await page.goto('http://localhost:3000/useless-whitespace-change-2.html')
