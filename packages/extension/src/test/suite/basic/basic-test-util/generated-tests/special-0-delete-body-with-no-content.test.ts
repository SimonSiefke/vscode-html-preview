...
test('special-0-delete-body-with-no-content', async () => {
	const uri = await createTestFile('special-0-delete-body-with-no-content.html')
  await setText(`<body>
  <h1>hello world</h1>
</body>`)
  ...
  await page.goto('http://localhost:3000/special-0-delete-body-with-no-content.html', {waitUntil: 'networkidle2', timeout: 10000})
  //await page.goto('http://localhost:3000/special-0-delete-body-with-no-content.html')
