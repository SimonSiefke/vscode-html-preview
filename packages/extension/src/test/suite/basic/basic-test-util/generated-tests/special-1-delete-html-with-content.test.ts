...
test('special-1-delete-html-with-content', async () => {
  ...
  await page.goto('http://localhost:3000/special-1-delete-html-with-content.html', {waitUntil: 'networkidle2', timeout: 10000})
  //await page.goto('http://localhost:3000/special-1-delete-html-with-content.html')
