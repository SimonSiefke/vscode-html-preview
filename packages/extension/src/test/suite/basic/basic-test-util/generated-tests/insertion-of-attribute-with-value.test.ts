...
test('insertion-of-attribute-with-value', async () => {
  ...
  await page.goto('http://localhost:3000/insertion-of-attribute-with-value.html', {waitUntil: 'networkidle2', timeout: 10000})
