...
test('insert-comment', async () => {
	const uri = await createTestFile('insert-comment.html')
  await setText(`<html>
  <head>
  </head>
  <body>
  ...
  await page.goto('http://localhost:3000/insert-comment.html', {waitUntil: 'networkidle2', timeout: 15000})
