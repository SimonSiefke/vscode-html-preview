...
test('weird-start-14', async () => {
	const uri = await createTestFile('weird-start-14.html')
...
<!--world-->`)
  ...
  await page.goto('http://localhost:3000/weird-start-14.html', {waitUntil: 'networkidle2', timeout: 15000})
