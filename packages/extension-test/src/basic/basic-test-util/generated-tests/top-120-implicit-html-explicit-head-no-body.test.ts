...
test('top-120-implicit-html-explicit-head-no-body', async () => {
	const uri = await createTestFile('top-120-implicit-html-explicit-head-no-body.html')
  await setText(`<head>
  <title></title>
</head>`)
  ...
  await page.goto('http://localhost:3000/top-120-implicit-html-explicit-head-no-body.html', {waitUntil: 'networkidle2', timeout: 15000})
