...
test('top-111-implicit-html-implicit-head-implicit-body', async () => {
	const uri = await createTestFile('top-111-implicit-html-implicit-head-implicit-body.html')
...
<b></b>`)
  ...
  await page.goto('http://localhost:3000/top-111-implicit-html-implicit-head-implicit-body.html', {waitUntil: 'networkidle2', timeout: 15000})
