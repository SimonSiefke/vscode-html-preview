...
test('top-200-explicit-html-no-head-no-body', async () => {
	const uri = await createTestFile('top-200-explicit-html-no-head-no-body.html')
  await setText(`<html>
</html>`)
  ...
  await page.goto('http://localhost:3000/top-200-explicit-html-no-head-no-body.html', {waitUntil: 'networkidle2', timeout: 15000})
