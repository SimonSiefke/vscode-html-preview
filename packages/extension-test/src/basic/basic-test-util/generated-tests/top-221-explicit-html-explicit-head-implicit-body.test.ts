...
test('top-221-explicit-html-explicit-head-implicit-body', async () => {
	const uri = await createTestFile('top-221-explicit-html-explicit-head-implicit-body.html')
  await setText(`<html>
  <head>
    <title></title>
  </head>
  ...
  await page.goto('http://localhost:3000/top-221-explicit-html-explicit-head-implicit-body.html', {waitUntil: 'networkidle2', timeout: 15000})
