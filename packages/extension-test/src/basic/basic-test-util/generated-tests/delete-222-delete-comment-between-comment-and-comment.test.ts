...
test('delete-222-delete-comment-between-comment-and-comment', async () => {
	const uri = await createTestFile('delete-222-delete-comment-between-comment-and-comment.html')
  await setText(`<!--a--><!--b--><!--c-->`)
  ...
  await page.goto('http://localhost:3000/delete-222-delete-comment-between-comment-and-comment.html', {waitUntil: 'networkidle2', timeout: 15000})
