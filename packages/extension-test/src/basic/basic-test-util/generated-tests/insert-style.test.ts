...
test('insert-style', async () => {
	const uri = await createTestFile('insert-style.html')
  await setText(`style
...
hello world`)
  ...
  await page.goto('http://localhost:3000/insert-style.html', {waitUntil: 'networkidle2', timeout: 15000})
...
await waitForUpdateEnd(page)
	...
	assert.equal(adjust(html), `<html><head><style></style>
