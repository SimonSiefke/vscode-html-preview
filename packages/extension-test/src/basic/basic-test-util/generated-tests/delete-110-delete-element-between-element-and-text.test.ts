...
test('delete-110-delete-element-between-element-and-text', async () => {
	const uri = await createTestFile('delete-110-delete-element-between-element-and-text.html')
  ...
  await page.goto('http://localhost:3000/delete-110-delete-element-between-element-and-text.html', {waitUntil: 'networkidle2', timeout: 15000})
