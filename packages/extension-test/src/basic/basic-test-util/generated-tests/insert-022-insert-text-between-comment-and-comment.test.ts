...
test('insert-022-insert-text-between-comment-and-comment', async () => {
	const uri = await createTestFile('insert-022-insert-text-between-comment-and-comment.html')
  await setText(`<!--a--><!--c-->`)
  ...
  await page.goto('http://localhost:3000/insert-022-insert-text-between-comment-and-comment.html', {waitUntil: 'networkidle2', timeout: 15000})
