...
test('replace-element-with-text', async () => {
	const uri = await createTestFile('replace-element-with-text.html')
  ...
  await page.goto('http://localhost:3000/replace-element-with-text.html', {waitUntil: 'networkidle2', timeout: 15000})
