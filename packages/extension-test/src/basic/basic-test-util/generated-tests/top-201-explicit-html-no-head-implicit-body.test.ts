...
test('top-201-explicit-html-no-head-implicit-body', async () => {
	const uri = await createTestFile('top-201-explicit-html-no-head-implicit-body.html')
  await setText(`<html>
  <b></b>
</html>`)
  ...
  await page.goto('http://localhost:3000/top-201-explicit-html-no-head-implicit-body.html', {waitUntil: 'networkidle2', timeout: 15000})
