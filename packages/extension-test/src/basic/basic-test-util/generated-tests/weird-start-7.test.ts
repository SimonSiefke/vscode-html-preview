...
test('weird-start-7', async () => {
	const uri = await createTestFile('weird-start-7.html')
...
hello`)
  ...
  await page.goto('http://localhost:3000/weird-start-7.html', {waitUntil: 'networkidle2', timeout: 15000})
