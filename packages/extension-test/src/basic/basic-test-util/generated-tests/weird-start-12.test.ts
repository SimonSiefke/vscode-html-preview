...
test('weird-start-12', async () => {
	const uri = await createTestFile('weird-start-12.html')
...
<html>
  ...
  await page.goto('http://localhost:3000/weird-start-12.html', {waitUntil: 'networkidle2', timeout: 15000})
