...
test('top-101-implicit-html-no-head-implicit-body', async () => {
	const uri = await createTestFile('top-101-implicit-html-no-head-implicit-body.html')
  await setText(`<b></b>`)
  ...
  await page.goto('http://localhost:3000/top-101-implicit-html-no-head-implicit-body.html', {waitUntil: 'networkidle2', timeout: 15000})
  // await new Promise(resolve => setTimeout(resolve, 444000))
	...
	assert.equal(adjust(html), `<html><head></head><body><b></b></body></html>`);
