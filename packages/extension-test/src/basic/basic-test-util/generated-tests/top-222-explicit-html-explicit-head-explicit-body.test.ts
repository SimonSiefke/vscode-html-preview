...
test('top-222-explicit-html-explicit-head-explicit-body', async () => {
	const uri = await createTestFile('top-222-explicit-html-explicit-head-explicit-body.html')
  await setText(`<html>
  <head>
    <title></title>
  </head>
  ...
  await page.goto('http://localhost:3000/top-222-explicit-html-explicit-head-explicit-body.html', {waitUntil: 'networkidle2', timeout: 15000})
