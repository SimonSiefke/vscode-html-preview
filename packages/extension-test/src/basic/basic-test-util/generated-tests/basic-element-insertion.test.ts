...
test('basic-element-insertion', async () => {
	const uri = await createTestFile('basic-element-insertion.html')
  ...
  await page.goto('http://localhost:3000/basic-element-insertion.html', {waitUntil: 'networkidle2', timeout: 15000})
