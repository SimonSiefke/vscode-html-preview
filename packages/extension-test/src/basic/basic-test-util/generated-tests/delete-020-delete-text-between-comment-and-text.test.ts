...
test('delete-020-delete-text-between-comment-and-text', async () => {
	const uri = await createTestFile('delete-020-delete-text-between-comment-and-text.html')
  await setText(`<!--a-->bc`)
  ...
  await page.goto('http://localhost:3000/delete-020-delete-text-between-comment-and-text.html', {waitUntil: 'networkidle2', timeout: 15000})
