...
test('delete-211-delete-comment-between-element-and-element', async () => {
	const uri = await createTestFile('delete-211-delete-comment-between-element-and-element.html')
  ...
  await page.goto('http://localhost:3000/delete-211-delete-comment-between-element-and-element.html', {waitUntil: 'networkidle2', timeout: 15000})
