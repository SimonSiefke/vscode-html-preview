...
test('weird-start-5', async () => {
	const uri = await createTestFile('weird-start-5.html')
...
<body>
  ...
  await page.goto('http://localhost:3000/weird-start-5.html', {waitUntil: 'networkidle2', timeout: 15000})
