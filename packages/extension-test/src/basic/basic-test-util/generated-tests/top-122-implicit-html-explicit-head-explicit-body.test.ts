...
test('top-122-implicit-html-explicit-head-explicit-body', async () => {
	const uri = await createTestFile('top-122-implicit-html-explicit-head-explicit-body.html')
  await setText(`<head>
  <title></title>
</head>
<body>
  ...
  await page.goto('http://localhost:3000/top-122-implicit-html-explicit-head-explicit-body.html', {waitUntil: 'networkidle2', timeout: 15000})
