...
test('attribute-value-replacement', async () => {
	const uri = await createTestFile('attribute-value-replacement.html')
  ...
  await page.goto('http://localhost:3000/attribute-value-replacement.html', {waitUntil: 'networkidle2', timeout: 15000})
