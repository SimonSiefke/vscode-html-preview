...
test('comment-before-style', async () => {
	const uri = await createTestFile('comment-before-style.html')
  await setText(`<!--a-->
<style>
* {
  font-size: 17px;
  ...
  await page.goto('http://localhost:3000/comment-before-style.html', {waitUntil: 'networkidle2', timeout: 15000})
