...
test('top-110-implicit-html-implicit-head-no-body', async () => {
	const uri = await createTestFile('top-110-implicit-html-implicit-head-no-body.html')
  ...
  await page.goto('http://localhost:3000/top-110-implicit-html-implicit-head-no-body.html', {waitUntil: 'networkidle2', timeout: 15000})
