...
test('top-210-explicit-html-implicit-head-no-body', async () => {
	const uri = await createTestFile('top-210-explicit-html-implicit-head-no-body.html')
  await setText(`<html>
  <title></title>
</html>`)
  ...
  await page.goto('http://localhost:3000/top-210-explicit-html-implicit-head-no-body.html', {waitUntil: 'networkidle2', timeout: 15000})
