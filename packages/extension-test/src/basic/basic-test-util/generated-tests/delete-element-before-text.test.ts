...
test('delete-element-before-text', async () => {
	const uri = await createTestFile('delete-element-before-text.html')
  ...
  await page.goto('http://localhost:3000/delete-element-before-text.html', {waitUntil: 'networkidle2', timeout: 15000})
...
await waitForUpdateEnd(page)
	...
	assert.equal(adjust(html), `<html><head></head><body>b</body></html>`);
