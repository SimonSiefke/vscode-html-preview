...
test('weird-start-1', async () => {
	const uri = await createTestFile('weird-start-1.html')
...
<!-- ! -->`)
  ...
  await page.goto('http://localhost:3000/weird-start-1.html', {waitUntil: 'networkidle2', timeout: 15000})
