...
test('top-100-implicit-html-no-head-no-body', async () => {
	const uri = await createTestFile('top-100-implicit-html-no-head-no-body.html')
  await setText(``)
  ...
  await page.goto('http://localhost:3000/top-100-implicit-html-no-head-no-body.html', {waitUntil: 'networkidle2', timeout: 15000})
