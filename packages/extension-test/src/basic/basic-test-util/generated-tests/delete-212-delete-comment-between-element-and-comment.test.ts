...
test('delete-212-delete-comment-between-element-and-comment', async () => {
	const uri = await createTestFile('delete-212-delete-comment-between-element-and-comment.html')
  ...
  await page.goto('http://localhost:3000/delete-212-delete-comment-between-element-and-comment.html', {waitUntil: 'networkidle2', timeout: 15000})
