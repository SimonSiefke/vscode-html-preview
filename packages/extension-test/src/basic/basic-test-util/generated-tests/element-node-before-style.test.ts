...
test('element-node-before-style', async () => {
	const uri = await createTestFile('element-node-before-style.html')
  await setText(`<h1></h1>
<style></style>`)
  ...
  await page.goto('http://localhost:3000/element-node-before-style.html', {waitUntil: 'networkidle2', timeout: 15000})
