...
test('delete-first-element-node', async () => {
	const uri = await createTestFile('delete-first-element-node.html')
  await setText(`<h1>hello</h1>
<button>button</button>`)
  ...
  await page.goto('http://localhost:3000/delete-first-element-node.html', {waitUntil: 'networkidle2', timeout: 15000})
