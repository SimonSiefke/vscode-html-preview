...
test('top-102-implicit-html-no-head-explicit-body', async () => {
	const uri = await createTestFile('top-102-implicit-html-no-head-explicit-body.html')
  await setText(`<body>
  <b></b>
</body>`)
  ...
  await page.goto('http://localhost:3000/top-102-implicit-html-no-head-explicit-body.html', {waitUntil: 'networkidle2', timeout: 15000})
