...
test('insert-021-insert-text-between-comment-and-element', async () => {
	const uri = await createTestFile('insert-021-insert-text-between-comment-and-element.html')
  ...
  await page.goto('http://localhost:3000/insert-021-insert-text-between-comment-and-element.html', {waitUntil: 'networkidle2', timeout: 15000})
...
await waitForUpdateEnd(page)
	...
	assert.equal(adjust(html), `<html><head></head><body>b<h1>c</h1></body></html>`);
