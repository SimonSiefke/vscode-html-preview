...
test('weird-start-2', async () => {
	const uri = await createTestFile('weird-start-2.html')
...
hello
  ...
  await page.goto('http://localhost:3000/weird-start-2.html', {waitUntil: 'networkidle2', timeout: 15000})
