...
test('weird-start-13', async () => {
	const uri = await createTestFile('weird-start-13.html')
  await setText(`<!-- hello -->
<!DOCTYPE html>
world`)
  ...
  await page.goto('http://localhost:3000/weird-start-13.html', {waitUntil: 'networkidle2', timeout: 15000})
