...
test('delete-200-delete-comment-between-text-and-text', async () => {
	const uri = await createTestFile('delete-200-delete-comment-between-text-and-text.html')
  await setText(`a<!--b-->c`)
  ...
  await page.goto('http://localhost:3000/delete-200-delete-comment-between-text-and-text.html', {waitUntil: 'networkidle2', timeout: 15000})
