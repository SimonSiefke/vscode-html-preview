...
test('delete-220-delete-comment-between-comment-and-text', async () => {
	const uri = await createTestFile('delete-220-delete-comment-between-comment-and-text.html')
  await setText(`<!--a--><!--b-->c`)
  ...
  await page.goto('http://localhost:3000/delete-220-delete-comment-between-comment-and-text.html', {waitUntil: 'networkidle2', timeout: 15000})
...
await waitForUpdateEnd(page)
	...
	assert.equal(adjust(html), `<html><head></head><body>c</body></html>`);
