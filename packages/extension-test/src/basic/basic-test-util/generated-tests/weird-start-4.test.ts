...
test('weird-start-4', async () => {
	const uri = await createTestFile('weird-start-4.html')
...
<body>
  ...
  await page.goto('http://localhost:3000/weird-start-4.html', {waitUntil: 'networkidle2', timeout: 15000})
