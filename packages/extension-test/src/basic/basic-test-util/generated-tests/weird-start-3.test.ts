...
test('weird-start-3', async () => {
	const uri = await createTestFile('weird-start-3.html')
...
hello`)
  ...
  await page.goto('http://localhost:3000/weird-start-3.html', {waitUntil: 'networkidle2', timeout: 15000})
