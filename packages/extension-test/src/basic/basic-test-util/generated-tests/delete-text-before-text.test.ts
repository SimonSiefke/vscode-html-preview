...
test('delete-text-before-text', async () => {
	const uri = await createTestFile('delete-text-before-text.html')
  await setText(`ab`)
  ...
  await page.goto('http://localhost:3000/delete-text-before-text.html', {waitUntil: 'networkidle2', timeout: 15000})
