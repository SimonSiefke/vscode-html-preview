...
test('weird-start-10', async () => {
	const uri = await createTestFile('weird-start-10.html')
...
<html>
  ...
  await page.goto('http://localhost:3000/weird-start-10.html', {waitUntil: 'networkidle2', timeout: 15000})
