...
test('delete-100-delete-element-between-text-and-text', async () => {
	const uri = await createTestFile('delete-100-delete-element-between-text-and-text.html')
  ...
  await page.goto('http://localhost:3000/delete-100-delete-element-between-text-and-text.html', {waitUntil: 'networkidle2', timeout: 15000})
