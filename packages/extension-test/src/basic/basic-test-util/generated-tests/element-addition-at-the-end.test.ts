...
test('element-addition-at-the-end', async () => {
	const uri = await createTestFile('element-addition-at-the-end.html')
  ...
  await page.goto('http://localhost:3000/element-addition-at-the-end.html', {waitUntil: 'networkidle2', timeout: 15000})
