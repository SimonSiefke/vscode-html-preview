...
test('delete-122-delete-element-between-comment-and-comment', async () => {
	const uri = await createTestFile('delete-122-delete-element-between-comment-and-comment.html')
  ...
  await page.goto('http://localhost:3000/delete-122-delete-element-between-comment-and-comment.html', {waitUntil: 'networkidle2', timeout: 15000})
