...
test('delete-121-delete-element-between-comment-and-element', async () => {
	const uri = await createTestFile('delete-121-delete-element-between-comment-and-element.html')
  ...
  await page.goto('http://localhost:3000/delete-121-delete-element-between-comment-and-element.html', {waitUntil: 'networkidle2', timeout: 15000})
...
await waitForUpdateEnd(page)
	...
	assert.equal(adjust(html), `<html><head></head><body><h1>c</h1></body></html>`);
