...
test('basic-text-replace', async () => {
	const uri = await createTestFile('basic-text-replace.html')
  ...
  await page.goto('http://localhost:3000/basic-text-replace.html', {waitUntil: 'networkidle2', timeout: 15000})
