...
test('weird-start-6', async () => {
	const uri = await createTestFile('weird-start-6.html')
...
<html>
  ...
  await page.goto('http://localhost:3000/weird-start-6.html', {waitUntil: 'networkidle2', timeout: 15000})
