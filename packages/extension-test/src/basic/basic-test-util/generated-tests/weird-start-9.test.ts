...
test('weird-start-9', async () => {
	const uri = await createTestFile('weird-start-9.html')
...
<html>
  ...
  await page.goto('http://localhost:3000/weird-start-9.html', {waitUntil: 'networkidle2', timeout: 15000})
