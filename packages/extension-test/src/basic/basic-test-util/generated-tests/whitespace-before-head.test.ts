...
test('whitespace-before-head', async () => {
	const uri = await createTestFile('whitespace-before-head.html')
  await setText(`
<head></head>`)
  ...
  await page.goto('http://localhost:3000/whitespace-before-head.html', {waitUntil: 'networkidle2', timeout: 15000})
