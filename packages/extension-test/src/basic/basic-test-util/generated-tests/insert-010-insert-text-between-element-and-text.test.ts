...
test('insert-010-insert-text-between-element-and-text', async () => {
	const uri = await createTestFile('insert-010-insert-text-between-element-and-text.html')
  ...
  await page.goto('http://localhost:3000/insert-010-insert-text-between-element-and-text.html', {waitUntil: 'networkidle2', timeout: 15000})
