...
test('top-212-explicit-html-implicit-head-explicit-body', async () => {
	const uri = await createTestFile('top-212-explicit-html-implicit-head-explicit-body.html')
  await setText(`<html>
  <title></title>
  <body>
    <b></b>
  ...
  await page.goto('http://localhost:3000/top-212-explicit-html-implicit-head-explicit-body.html', {waitUntil: 'networkidle2', timeout: 15000})
