...
test('delete-021-delete-text-between-comment-and-element', async () => {
	const uri = await createTestFile('delete-021-delete-text-between-comment-and-element.html')
  ...
  await page.goto('http://localhost:3000/delete-021-delete-text-between-comment-and-element.html', {waitUntil: 'networkidle2', timeout: 15000})
